              ...
              <div className="card__box">
                <div className="card__item yellow">
                  ...
                  <p className="card__today">
                    ...
                    <CountUp
                      start={0}
                      end={data.critical ? data.critical : 0}
                      duration={1}
                      separator=","
                    />
                  </p>
              ...
              <div className="card__box">
                <div className="card__item green">
                  ...
                  <h3 className="card__number">
                    <CountUp
                      start={0}
                      end={data.recovered ? data.recovered : 0}
                      duration={1}
                      separator=","
                    />
                  </h3>
                  <p className="card__today">
                    ...
                    <CountUp
                      start={0}
                      end={data.todayRecovered ? data.todayRecovered : 0}
                      duration={1}
                      separator=","
                    />
                  </p>
              ...
              <div className="card__box">
                <div className="card__item black">
                  ...
                  <p className="card__today">
                    ...
                    <CountUp
                      start={0}
                      end={data.todayDeaths ? data.todayDeaths : 0}
                      duration={1}
                      separator=","
                    />
                  </p>
              ...
              <div className="card__box">
                <div className="card__item red">
                  ...
                  <p className="card__today">
                    ...
                    <CountUp
                      start={0}
                      end={data.todayCases ? data.todayCases : 0}
                      duration={1}
                      separator=","
                    />
                  </p>
